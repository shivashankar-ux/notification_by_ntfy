...
* `twilio-account` is the Twilio account SID, e.g. AC_EXAMPLE_TWILIO_ACCOUNT_SID
...
=== "Custom TwiML (English)"
    ``` yaml
    twilio-account: "AC_EXAMPLE_TWILIO_ACCOUNT_SID"
...
| `twilio-account`                           | `NTFY_TWILIO_ACCOUNT`                           | *string*                                            | -                 | Twilio account SID, e.g. AC_EXAMPLE_TWILIO_ACCOUNT_SID                                                                                                                                                                                  |
